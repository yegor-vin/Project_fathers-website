...
function showSlides() {
  var slides = document.querySelectorAll('.slideshow__img-container'); // set all slides display to none
  ...
  slides.forEach(function (slide) {
    return slide.classList.remove('slideshow__img-container--visible');
...
var burgerMenuBtn = document.querySelector('.header__burger-menu-btn');
var burgerMenu = document.querySelector('.header__burger-menu');
var closeBtn = document.querySelector('.header__close-btn');
var navLinks = document.querySelectorAll('.nav__link'); // Function to close the burger menu
...
//# sourceMappingURL=/Project_fathers-website/app.40eff92e.js.map